...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->energy_points--;
		std::cout << "ClapTrap " << this->name << " is repaired and receives " << amount << " hit points" << std::endl;
	}
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap " << this->name << " was attacked and loses " << amount << " hit points" << std::endl;
}
