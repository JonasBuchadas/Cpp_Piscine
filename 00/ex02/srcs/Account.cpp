...
void Account::makeDeposit(int amount) {
	...
	_totalNbDeposits++;
	_displayTimestamp();
	std::cout << "index:" << _accountIndex << ";p_amount:" << checkAmount() << ";deposit:" << amount << ";amount:" << _amount << ";nb_deposits:" << _nbDeposits << std::endl;
}
...
bool Account::makeWithdrawal(int amount)
{
	...
	_totalNbWithdrawals++;
	_displayTimestamp();
	std::cout << "index:" << _accountIndex << ";p_amount:" << checkAmount() << ";withdrawal:" << amount << ";amount:" << _amount << ";nb_withdrawals:" << _nbWithdrawals << std::endl;
	return true;
}
